...
import io.quarkiverse.langchain4j.docling.deployment.config.DoclingBuildTimeConfig;
...
import io.quarkus.deployment.dev.devservices.GlobalDevServicesConfig.Enabled;
import io.quarkus.deployment.logging.LoggingSetupBuildItem;
import io.quarkus.runtime.configuration.ConfigUtils;
import io.smallrye.config.SmallRyeConfig;

@BuildSteps(onlyIfNot = IsNormal.class, onlyIf = Enabled.class)
class Langchain4jDoclingDevServicesProcessor {
    private static final Logger LOG = Logger.getLogger(Langchain4jDoclingDevServicesProcessor.class);

    public static final String FEATURE = "langchain4j-docling-dev-service";
