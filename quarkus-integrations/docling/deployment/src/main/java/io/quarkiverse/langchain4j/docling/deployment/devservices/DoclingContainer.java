package io.quarkiverse.langchain4j.docling.deployment.devservices;
...
public class DoclingContainer extends GenericContainer<DoclingContainer> {
     ...
     */
    public static final String CONFIG_DOCLING_PORT = Langchain4jDoclingDevServicesProcessor.FEATURE + ".docling.port";

    /**
     * Configuration key for the host name used by the Docling dev service
     */
    public static final String CONFIG_DOCLING_HTTP_SERVER = Langchain4jDoclingDevServicesProcessor.FEATURE + ".docling.host";

    /**
     * Configuration key for the API endpoint used by the Docling dev service
     */
    public static final String CONFIG_DOCLING_API_ENDPOINT = Langchain4jDoclingDevServicesProcessor.FEATURE
            + ".docling.api.endpoint";

    /**
     * Configuration key for the documentation endpoint used by the Docling dev service
     */
    public static final String CONFIG_DOCLING_API_DOC = Langchain4jDoclingDevServicesProcessor.FEATURE + ".docling.api.doc";

    /**
     * Configuration key for the UI endpoint used by the Docling dev service
     */
    public static final String CONFIG_DOCLING_UI = Langchain4jDoclingDevServicesProcessor.FEATURE + ".docling.ui";
    ...
    DoclingContainer(DoclingDevServicesConfig config, Optional<Duration> timeout, boolean useSharedNetwork) {
        ...
        withLabel(Langchain4jDoclingDevServicesProcessor.DEV_SERVICE_LABEL, Langchain4jDoclingDevServicesProcessor.PROVIDER);
    ...
    protected void configure() {
        ...
        if (this.useSharedNetwork) {
            this.hostName = ConfigureUtil.configureSharedNetwork(this, Langchain4jDoclingDevServicesProcessor.PROVIDER);
        }
    }
